 ...
 * @returns 深いコピーの結果
 */
export function deepCopy<T = unknown>(obj: T, options: DeepCopyOptions = {}): DeepCopyResult<T> {
 ...
 * @returns コピーされた値
 */
function copyValue(value: unknown, visited: WeakMap<object, unknown>, options: DeepCopyOptions): unknown {
    // null または undefined
 ...
 * @returns 処理された値
 */
function handleFunction(value: Function, options: DeepCopyOptions): unknown {
 ...
 * @returns コピーされた配列
 */
function copyArray(arr: unknown[], visited: WeakMap<object, unknown>, options: DeepCopyOptions): unknown[] {
    // 循環参照チェック
    if (visited.has(arr)) {
 ...
 * @returns コピーされたSet
 */
function copySet(set: Set<unknown>, visited: WeakMap<object, unknown>, options: DeepCopyOptions): Set<unknown> {
    // 循環参照チェック
    if (visited.has(set)) {
 ...
 * @returns コピーされたMap
 */
function copyMap(map: Map<unknown, unknown>, visited: WeakMap<object, unknown>, options: DeepCopyOptions): Map<unknown, unknown> {
    // 循環参照チェック
    if (visited.has(map)) {
        return handleCircularReference(visited.get(map), options) as Map<unknown, unknown>;
    }
 ...
 */
function copyObject(obj: object, visited: WeakMap<object, unknown>, options: DeepCopyOptions): object {
    // 循環参照チェック
    if (visited.has(obj)) {
 ...
 * @returns 処理された値
 */
function handleCircularReference(value: unknown, options: DeepCopyOptions): unknown {
