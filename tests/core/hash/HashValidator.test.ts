...
import { isValidHash, isValidShortHash, verifyHashIntegrity, verifyObjectHashIntegrity } from '@/core/hash/HashValidator';
import {
    expectValidHash,
    INVALID_HASHES,
    runValidationTests,
...
describe('Hash Validator Functions', () => {
    describe('isValidHash', () => {
        ...
        it('should return false for string with invalid characters', () => {
            expect(isValidHash('a1b2c3d4e5f6789012345678901234567890abcz')).toBe(false);
        });
    });
